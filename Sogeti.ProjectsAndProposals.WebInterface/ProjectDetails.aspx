<%@ Page Title="Project Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProjectDetails.aspx.cs" Inherits="Sogeti.ProjectsAndProposals.WebInterface.ProjectDetails" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <table style="width: 75%;">
        ...
        <tr>
            <td>Start Date:</td>
            <td><asp:TextBox ID="startdate" class="field" runat="server"></asp:TextBox></td>
            <td>End Date:</td>
            <td><asp:TextBox ID="enddate" class="field" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td>Revised Date:</td>
